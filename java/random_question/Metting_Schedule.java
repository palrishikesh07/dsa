import java.util.Arrays;
 ...
 class Metting_Schedule {
    public static void main(String[] args) {
        int[][] metting1 = {{4,6},{7,8},{1,3}};
        // int[][] metting2 = {{1,4},{2,5},{6,8}};
        boolean everythingFine = isMettingOk(metting1);
    ...
    public static boolean isMettingOk(int[][] meeting){
        ...
        System.out.println("Sorted meeting schedule: " + Arrays.deepToString(meeting));
